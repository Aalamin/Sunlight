...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def send_group_mod(self, datapath):
       ...
       # Receiver port2, forward it to Port10
       #actions1 = [parser.OFPActionOutput(1)]
        ...
        # Receiver port2, forward it to Port11
        #actions1 = [parser.OFPActionOutput(1)]
        ...
        datapath.send_msg(req)
        # Group table3
        # Receive Port4, forward it to port1 and Port5
        # Receiver port2, forward it to Port7
        #actions1 = [parser.OFPActionOutput(1)]
        ...
        datapath.send_msg(req)
        # Group table4
        # Receive Port6, forward it to port1 and Port7
        # Receiver port2, forward it to Port8
       # actions1 = [parser.OFPActionOutput(1)]
        ...
        datapath.send_msg(req)
        # Group table5
        # Receive Port8, forward it to port1 and Port9
        # Receiver port2, forward it to Port9
       # actions1 = [parser.OFPActionOutput(1)]
